...
from apps.sexos.models import Sexo as Transaction
from apps.sexos.transaction_list.views import TransactionListView
from apps.sexos.transaction_add.views import TransactionAddView
from apps.sexos.transaction_update.views import TransactionUpdateView
from apps.sexos.transaction_delete.views import TransactionDeleteView
