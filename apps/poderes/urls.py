...
from apps.poderes.transaction_list.views import TransactionListView
from apps.poderes.transaction_add.views import TransactionAddView
from apps.poderes.transaction_update.views import TransactionUpdateView
from apps.poderes.transaction_delete.views import TransactionDeleteView
