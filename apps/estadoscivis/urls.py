...
from apps.estadoscivis.models import EstadoCivil as Transaction
from apps.estadoscivis.transaction_list.views import TransactionListView
from apps.estadoscivis.transaction_add.views import TransactionAddView
from apps.estadoscivis.transaction_update.views import TransactionUpdateView
from apps.estadoscivis.transaction_delete.views import TransactionDeleteView
